...
class GoogleSheetsService:
    ...
    def _initialize_sheets(self):
        ...
        required_sheets = [
            ...
            ("Рахунки", ["Номер", "Дата", "ЄДРПОУ контрагента", "Ім'я контрагента", "Товари", "Загальна сума", "Drive File ID", "На основі замовлення", "PDF Generated At"]),
            ("Акти", ["Номер", "Дата", "ЄДРПОУ контрагента", "Ім'я контрагента", "Роботи", "Загальна сума", "Drive File ID", "На основі замовлення", "На основі договору", "PDF Generated At"]),
            ("Видаткові накладні", ["Номер", "Дата", "ЄДРПОУ контрагента", "Ім'я контрагента", "Товари", "Загальна сума", "Drive File ID", "На основі замовлення", "PDF Generated At"]),
