...
class GoogleSheetsService:
    ...
    def _initialize_sheets(self):
        ...
        required_sheets = [
            ...
            ("Рахунки", ["Номер", "Дата", "ЄДРПОУ контрагента", "Ім'я контрагента", "Товари", "Загальна сума", "Drive File ID"]),
            ("Акти", ["Номер", "Дата", "ЄДРПОУ контрагента", "Ім'я контрагента", "Роботи", "Загальна сума", "Drive File ID"]),
            ("Видаткові накладні", ["Номер", "Дата", "ЄДРПОУ контрагента", "Ім'я контрагента", "Товари", "Загальна сума", "Drive File ID"]),
            ("Договори", ["Номер", "Дата", "ЄДРПОУ контрагента", "Ім'я контрагента", "Тип договору", "Предмет договору", "Сума договору", "Drive File ID"]),
