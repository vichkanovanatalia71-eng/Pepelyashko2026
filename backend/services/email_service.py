...
class EmailService:
    ...
    def send_order_shipped_notification(
        ...
        """
        Send shipment notification to counterparty when order status changes to 'shipped'.
        Includes TTN number for tracking.
        """
        formatted_date = order_date  # Already formatted
        company_display = company_name or 'Компанія'
        ...
        # TTN display
        ttn_display = ttn_number if ttn_number else "Не вказано"
        ttn_section = ""
        if ttn_number:
            ttn_section = f"""
                    <div class="ttn-box">
                        <div class="ttn-label">📦 Номер ТТН для відстеження:</div>
                        <div class="ttn-number">{ttn_number}</div>
                    </div>
            """
        
        subject = f"🚚 Ваше замовлення №{order_number} відправлено!"
        ...
        <body>
            <div class="email-container">
                ...
                <div class="header">
                    ...
                    <p>Замовлення №{order_number}</p>
                </div>
                <div class="content">
                    <p class="greeting">Шановні партнери!</p>
                    <div class="status-badge">📦 Статус: ВІДПРАВЛЕНО</div>
                    <p>Раді повідомити, що ваше замовлення №<strong>{order_number}</strong> від <strong>{formatted_date}</strong> готове та відправлено!</p>
                    {ttn_section}
                    <div class="info-box">
                        <div class="info-row">
                            <span class="info-label">📋 Номер замовлення:</span>
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">{ttn_display}</span>
                        </div>
                    </div>
                    <div class="total">
                        <div class="total-label">СУМА ЗАМОВЛЕННЯ:</div>
                ...
                <div class="footer">
                    <p>Дякуємо за співпрацю! • {company_display}</p>
                </div>
            </div>
        </body>
        </html>
        ...
        return self.send_email_with_attachment(
            ...
            body=body,
            attachment_path=pdf_path,
            attachment_name=f"Замовлення_{order_number}_відправлено.pdf",
            embedded_image_path=company_logo_path if has_logo else None
        )
    ...
    def send_waybill_document(
        ...
        <body>
            <div class="email-container">
                ...
                <div class="content">
                    <p>Доброго дня!</p>
                    <p><strong>{company_display_name}</strong> надсилає Вам видаткову накладну №<strong>{waybill_number}</strong> від <strong>{formatted_date}</strong>.</p>
                    <div class="info-box">
                        <div class="info-row">
