...
| `act_date_text_full` | string | Дата прописом повністю | "дев'ятого грудня дві тисячі двадцять п'ятого року" |
...
- **Всього змінних:** 35
- **Інформація про акт:** 7 змінних (додано `city`, `act_date_text_full`)
