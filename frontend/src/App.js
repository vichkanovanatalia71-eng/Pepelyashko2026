            ...
            <div className="space-y-4 py-4 overflow-y-auto" style={{maxHeight: 'calc(90vh - 200px)'}}>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  * Шаблон завжди доступний. За замовчуванням використовується базовий шаблон з реквізитами сторін<br/>
                  * Використовуйте кнопки форматування на панелі вгорі для стилізації тексту<br/>
                  * Клікніть на змінну вище для автоматичної вставки в текст
                </p>
              </div>
            </div>
