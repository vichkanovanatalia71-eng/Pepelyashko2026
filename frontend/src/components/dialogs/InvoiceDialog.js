          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-4 flex justify-end">
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  <p className="text-lg font-bold text-green-900">Всього: {invoice.total_amount.toFixed(2)} грн</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input value={invoice.number} disabled className="bg-gray-100" />
              </div>
              <div>
                <Label>Дата</Label>
                <Input
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input value={invoice.counterparty_edrpou} disabled className="bg-white" />
                </div>
                <div>
                  <Label className="text-sm">Назва</Label>
                  <Input value={invoice.counterparty_name} disabled className="bg-white" />
                </div>
              </div>
            </div>
