...
/* ── Tab: Огляд ── */
function TabOverview({ nhsuGrandAmount, nhsuGrandEpVz, totalPaidRevenue, paidDash, fi, ownerName }: {
  nhsuGrandAmount: number; nhsuGrandEpVz: number; totalPaidRevenue: number;
